...
namespace Player.Scripts
{
    public class AnimateGun : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (IsReloading() || player.isLocked || player.isScanning || player.isBackpackOpen)
                HideGun();
        ...
        private void ApplyMovement()
        {
            ...
            gun.localPosition = Vector3.SmoothDamp(gun.localPosition, targetPosition + offsetPosition, ref velocity, ComputeSpeed());
        }
